    ...
    if (withFactors) {
      ...
      return NextResponse.json({
        ...
        moonPhase: {
          ...
          isVoidOfCourse: forecast.moonPhase?.isVoidOfCourse,
          voidStart: forecast.moonPhase?.voidStart?.toISOString?.() || null,
          voidEnd: forecast.moonPhase?.voidEnd?.toISOString?.() || null,
        },
